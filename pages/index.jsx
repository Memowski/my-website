                 ...
                 Mehmet Özalp
                  ...
                  <Tippy content={`Online`} animation="shift-away" arrow={false}>
                    <span className={`ml-2 text-online px-2 py-1 font-normal rounded-md text-sm`}>
                          <i className={`fa fa-circle text-online mr-2`} />Çevrim içi
                    </span>
                  </Tippy>
...
Herkese merhaba, ben Mehmet. İnternet üzerinden para kazanma , kişisel gelişim ve eğlence tarzında videolar yüklediğim YouTube kanalım var...
              ...
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="umutbayraktar" src={`https://cdn.discordapp.com/attachments/1051236432418709635/1059104261373427742/IMG_20221208_184434_451.jpg`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
 ...
 <p className="text-3xl text-white font-semibold">Videolar</p>
